...
export function CardActions({ profile }: CardActionsProps) {
  ...
  return (
    <div className="space-y-3" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      {/* ── BLUE ACCENT 1 OF 2: Save Contact Primary Button (#2F7BFF) ── */}
      <button
        ...
        className={`w-full h-11 rounded-lg text-[13px] font-semibold tracking-wide transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99] ${
          saved
            ? "bg-emerald-600 text-white"
            : "bg-[#2F7BFF] hover:bg-[#1A5FCC] text-white shadow-[0_2px_12px_rgba(47,123,255,0.25)]"
        }`}
      >
        {saved ? (
          <>
      ...
      <div className="flex items-center justify-between pt-1">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-1.5 text-[12.5px] font-medium text-zinc-400 hover:text-white transition-colors"
        >
