    ...
    <div ref={containerRef} className={className} style={{ opacity: 0 }}>
      ...
      >
        ...
        <g stroke="url(#codeGradient)" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
          ...
          <g ref={codeRef} style={{ opacity: 0.4 }}>
            {/* Line 1: <div> */}
            <text x="35" y="75" fontSize="12" fontFamily="monospace" fill="url(#codeGradient)" opacity="0.8">
              &lt;div&gt;
            </text>

            {/* Line 2: className */}
            <text x="45" y="95" fontSize="11" fontFamily="monospace" fill="var(--color-accent)" opacity="0.6">
              className=
            </text>

            {/* Line 3: indented content */}
            <text x="55" y="115" fontSize="11" fontFamily="monospace" fill="var(--color-accent)" opacity="0.5">
              "build"
            </text>

            {/* Line 4: closing tag */}
            <text x="35" y="135" fontSize="12" fontFamily="monospace" fill="url(#codeGradient)" opacity="0.7">
              &lt;/div&gt;
            </text>

            {/* Line 5: another tag */}
            <text x="35" y="160" fontSize="12" fontFamily="monospace" fill="url(#codeGradient)" opacity="0.6">
              &lt;span&gt;...&lt;/span&gt;
            </text>

            {/* Line 6: closing */}
            <text x="35" y="185" fontSize="12" fontFamily="monospace" fill="url(#codeGradient)" opacity="0.5">
              &lt;/&gt;
            </text>
          </g>
