      ...
      <div className="portfolio-container relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <div ref={backBtnWrapperRef} className="mb-8 sm:mb-10">
              <BackButton href="/work#gallery" label="Back to Works Archive" />
            </div>

            {/* Eyebrow & Category Info */}
            <div ref={badgeRef} className="flex flex-wrap items-center gap-3.5 mb-6">
            ...
            {/* Minimal Tags */}
            <div ref={tagsRef} className="flex flex-wrap gap-2 sm:gap-2.5 mb-10">
            ...
            <div ref={actionsRef} className="flex flex-wrap items-center gap-4">
              {project.liveUrl ? (
                ...
                <div className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-xs font-medium" style={{ color: "var(--fg-muted)" }}>
          ...
          {/* Right Column: Smaller Showcase Centerpiece */}
          <div className="lg:col-span-7 mt-8 lg:mt-0">
            <div
              ref={previewRef}
              className="rounded-2xl bg-white dark:bg-[#09090c] border border-black/10 dark:border-white/15 p-2 sm:p-3 shadow-md dark:shadow-2xl overflow-hidden transition-all duration-500 w-full"
            >
              {/* Header Bar */}
              <div className="flex items-center justify-between px-4 py-2 bg-[#f3f4f8] dark:bg-[#111116] rounded-t-xl border-b border-black/5 dark:border-white/5">
                ...
                {project.liveUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[11px] font-medium text-[#3b82f6] dark:text-[#60a5fa] hover:underline flex items-center gap-1"
                  >
              ...
              {/* Media Viewport */}
              <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] bg-[#f5f6fa] dark:bg-[#050507] rounded-b-2xl overflow-hidden">
                <Image
                  src={project.image}
